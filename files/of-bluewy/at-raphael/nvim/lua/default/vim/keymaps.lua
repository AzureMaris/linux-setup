...
vim.keymap.set(
   ...
   "<C-A-u>",
   "<C-w>k",
   { noremap = true, silent = true, desc = "focus upper pane" }
)
vim.keymap.set(
   "n",
   "<C-A-i>",
   "<C-w>l",
   { noremap = true, silent = true, desc = "focus right pane" }
)
vim.keymap.set(
   "n",
   "<C-A-e>",
   "<C-w>j",
   { noremap = true, silent = true, desc = "focus bottom pane" }
)
vim.keymap.set(
   "n",
   "<C-A-n>",
   "<C-w>h",
   { noremap = true, silent = true, desc = "focus left pane" }
)
...
vim.keymap.set(
   ...
   "<leader>ra",
   vim.lsp.buf.rename,
   { noremap = true, silent = true, desc = "refactor rename" }
)
vim.keymap.set(
   "n",
   "<leader>ca",
